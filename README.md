...
* [Oracle Graph Server and Client 20.2](https://www.oracle.com/database/technologies/spatialandgraph/property-graph-features/graph-server-and-client/graph-server-and-client-downloads.html)
...
- oracle-graph-20.2.0.x86_64.rpm
- oracle-graph-zeppelin-interpreter-20.2.0.zip
